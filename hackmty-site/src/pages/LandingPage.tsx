    ...
    return (
        <Box sx={{paddingY: '10vh', minHeight: '100vh' }}>
            ...
            <Box id="countdown-and-location">
                ...
                <Typography sx={{marginTop:10, color:'white', fontSize:'clamp(0.3rem, 4vw + 2rem, 9rem)', fontWeight:700, transition: 'transform 0.3s ease','&:hover': {transform: 'translateY(-10px) scale(1.05)'}}}>October 24-26</Typography>
                <Typography sx={{marginTop:0, color:'white', fontSize:'clamp(0.3rem, 1vw + 1rem, 3rem)', fontWeight:400, transition: 'transform 0.3s ease','&:hover': {transform: 'translateY(-10px)'}}}>Hackathon @Tec de Monterrey, Monterrey NL</Typography>
            </Box>

            <Box sx={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center'}}>
                <Box marginTop='20vh' sx={{backgroundColor:"white", width: {xs: 'fit-content', sm: '60%'}, display:'block', px:'clamp(5rem, 3vw + 3rem, 8rem)', borderRadius:'clamp(8px, 5vw + 2rem, 40px)'}}>
                    <Typography fontSize={'clamp(0.5rem, 2vw + 2rem, 5rem)'} fontWeight={700} color="secondary.main" textTransform={'uppercase'}>About us</Typography>
                </Box>
                ...
                <Box marginTop='15vh' sx={{backgroundColor:"white", width: {xs: 'fit-content', sm: '60%'}, display:'block', px:'clamp(5rem, 2vw + 4rem, 5rem)', borderRadius:'clamp(8px, 5vw + 2rem, 40px)'}}>
                ...
                <Box display='flex' sx={{width:'80%', flexDirection:{xs:'column', md:'row'}}} gap={{xs: '2rem', md: '3vw'}} marginTop={'3vh'} alignItems={{xs: 'center', md: 'stretch'}} mx={'3vw'}>
                   <MapComponent position={[25.650879335256544, -100.28725971757876]} zoom={1000} markers={[{position: [25.6506, -100.28735], color:'purple', popupText: 'Arena Borregos' },]}></MapComponent>
                </Box>
            </Box>
        </Box>
    )
